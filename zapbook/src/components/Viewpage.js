  ...
  <section className="main flex flex-col content-center justify-center ">
     <div className="area home_info flex-row self-center justify-center drop-shadow-xl backdrop-blur-xl rounded-lg p-5 pb-0 ">
         <div className="menubar text-xl flex  lg:flex-row">
           ...
           {/* <span className={`title_tag mx-4 rounded-lg text-sm h-5 p-0.5 drop-shadow-md backdrop-blur-xl ${tag_class}`} > */}
            {/* <div className="tagss drop-shadow-xl"> */}
               <textarea className={`title_tag mx-4 rounded-lg text-sm h-5 p-0.5 drop-shadow-md backdrop-blur-xl tagu  drop-shadow-xl ${tag_class}`} onChange={onChange} placeholder='tag : '></textarea> 
               {/* <ul>
         ...
         <div className="txtarea mx-4 my-2 rounded-lg">
           <textarea className="description text_area p-2" name="Notes" onChange={onChange} placeholder='enter your Note here' style={{width:"100%" , boxShadow: " inset 0px 1px 10px 0px rgba(48,48,48,0.6)" , borderRadius: "10px" , backgroundColor: "rgba(205, 205, 255 ,0.6)" , color: "black" , minHeight: "100%" }}></textarea>
         </div>
